...
const config = {
  api: {
    host: 'http://199.247.4.48', // ex: 'https://explorer.bulwarkcrypto.com' for nginx (SSL), 'http://IP_ADDRESS' 
  ...
  coinDetails: {
    ...
    shortName: 'BIT',
    displayDecimals: 2,
    longName: 'Bitmoney Cryptocurrency',
    ...
    websiteUrl: 'https://bitmoney.ws/',
    masternodeCollateral: 175000, // MN ROI% gets based on this number. If your coin has multi-tiered masternodes then set this to lowest tier (ROI% will simply be higher for bigger tiers)
  },
  offChainSignOn: {
    enabled: true,
